...
for name in ('numpy numba dask').split():
    try:
...
htmlhelp_basename = 'pyscenariosdoc'
...
latex_documents = [
  ('index', 'pyscenarios.tex', 'pyscenarios Documentation',
   'pyscenarios Developers', 'manual'),
]
...
man_pages = [
    ('index', 'pyscenarios', 'pyscenarios Documentation',
     ['pyscenarios Developers'], 1)
]
...
texinfo_documents = [
  ('index', 'pyscenarios', 'pyscenarios Documentation',
   'pyscenarios Developers', 'pyscenarios',
